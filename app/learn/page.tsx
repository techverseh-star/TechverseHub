...
const LANGUAGES = [
  ...
  { id: "go", name: "Go", icon: "🔷", color: "cyan", description: "Fast, simple systems language" },
  { id: "rust", name: "Rust", icon: "🦀", color: "orange", description: "Safe systems programming" },
];
...
const DEMO_LESSONS: Lesson[] = [
  ...
  { id: "go-01", title: "Introduction to Go", language: "go", level: "beginner", content: "Simple, fast, concurrent", codeExample: "", tryStarter: "" },
  { id: "go-02", title: "Variables and Types", language: "go", level: "beginner", content: "Static typing in Go", codeExample: "", tryStarter: "" },
  { id: "go-03", title: "Control Flow", language: "go", level: "beginner", content: "If, switch, for", codeExample: "", tryStarter: "" },
  { id: "go-04", title: "Functions", language: "go", level: "beginner", content: "Multiple return values", codeExample: "", tryStarter: "" },
  { id: "go-05", title: "Structs", language: "go", level: "intermediate", content: "Custom types", codeExample: "", tryStarter: "" },
  { id: "go-06", title: "Interfaces", language: "go", level: "intermediate", content: "Implicit interfaces", codeExample: "", tryStarter: "" },
  { id: "go-07", title: "Goroutines", language: "go", level: "advanced", content: "Concurrent programming", codeExample: "", tryStarter: "" },
  { id: "go-08", title: "Channels", language: "go", level: "advanced", content: "Communication between goroutines", codeExample: "", tryStarter: "" },

  { id: "rust-01", title: "Introduction to Rust", language: "rust", level: "beginner", content: "Safe systems programming", codeExample: "", tryStarter: "" },
  { id: "rust-02", title: "Variables and Types", language: "rust", level: "beginner", content: "Immutability by default", codeExample: "", tryStarter: "" },
  { id: "rust-03", title: "Control Flow", language: "rust", level: "beginner", content: "If, match, loops", codeExample: "", tryStarter: "" },
  { id: "rust-04", title: "Functions", language: "rust", level: "beginner", content: "Expression-based returns", codeExample: "", tryStarter: "" },
  { id: "rust-05", title: "Ownership", language: "rust", level: "intermediate", content: "Memory safety", codeExample: "", tryStarter: "" },
  { id: "rust-06", title: "Structs and Enums", language: "rust", level: "intermediate", content: "Custom types", codeExample: "", tryStarter: "" },
  { id: "rust-07", title: "Error Handling", language: "rust", level: "advanced", content: "Result and Option", codeExample: "", tryStarter: "" },
  { id: "rust-08", title: "Traits", language: "rust", level: "advanced", content: "Shared behavior", codeExample: "", tryStarter: "" },
];
